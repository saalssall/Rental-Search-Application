  ...
  return (
    <Box sx={{ backgroundColor: COLORS.light, minHeight: "80vh", display: "flex", justifyContent: "center", alignItems: "center" }}>
      <Box sx={{ backgroundColor: "#fff", display: "flex", flexDirection: "column", gap: 2, width: "100%", maxWidth: 400, p: 4, boxShadow: 3, borderRadius: 2 }}>
        ...
        <Button variant="contained" onClick={registerUser} fullWidth sx={{ backgroundColor: COLORS.dark, "&:hover": { backgroundColor: COLORS.muted } }}>
          Submit
        </Button>
        <Typography textAlign="center">
          Already a member?{" "}
          <Link to="/login" style={{ color: COLORS.dark, fontWeight: 600 }}>Click here to Login!</Link>
        </Typography>
      </Box>
    </Box>
  );
